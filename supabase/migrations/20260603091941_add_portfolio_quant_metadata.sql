...
comment on column public.portfolios.strategy_tag is 'Investment strategy tag used by NetVisualizer Quant views.';
comment on column public.portfolios.avg_buy_price is 'Optional average buy price per share/unit. Currency follows the row currency.';
