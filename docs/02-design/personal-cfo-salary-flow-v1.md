...
| 월급통장 | 잔액 목표 50만원 | 운영현금 |
| 생활비통장 | 잔액 목표 50만원 | 운영현금 |
...
flowchart LR
    ...
    Allocation --> SalaryCash["월급통장 잔액"]
    Allocation --> LivingCash["생활비통장 잔액"]
    Allocation --> Note["원화 발행어음"]
```

모든 목적지는 같은 세로 열에 배치하고 수평·수직 꺾인선을 공유한다. 전세대출 노드는 부채가 아니라 주거자금으로 표현한다.

## Quality Gates

- 월급 배분 목적지 합계는 월급과 같아야 한다.
- 전세대출 100만원과 같은 금액의 liability 노드가 없어야 한다.
