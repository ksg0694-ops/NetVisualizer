...
Local full tests and rendered chart checks passed. Source-backed read-only eligibility validation confirms September compares all eight prior 2026 periods. Publication pending CI/deployment verification.
