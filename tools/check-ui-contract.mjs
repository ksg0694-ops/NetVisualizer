...
assert.ok(checklist.includes('applyNoteIndentation(noteEditor, event.shiftKey)'), 'Shift+Tab must outdent Todo notes');
...
assert.ok(checklist.indexOf('data-note-preview-for=') < checklist.indexOf('data-checklist-note-editor class='), 'live note preview must appear above the editor');
