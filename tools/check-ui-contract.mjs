...
assert.ok(checklist.includes('id="checklist-life-notes-panel"'));
assert.ok(checklist.includes("activeDomain === 'life'"));
...
assert.ok(!index.includes('data-target="life-notes-view"'), 'Life Notes must be embedded in the Todo Life group');
